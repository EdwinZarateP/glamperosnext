...
export const enviarWhatsAppReagendamiento = async ({
  numero,
  nombrePropietario,
  codReserva,
}: EnviarWhatsAppProps) => {
  try {
    ...
    const body = {
      ...
      type: "template",
      template: {
        name: "reagendamiento", // 🔹 Asegúrate de que este nombre es EXACTO al de Meta Business
        language: { code: "es_CO" },
        components: [
          {
            type: "body",
